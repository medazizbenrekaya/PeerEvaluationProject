    ...
    render() {
        ...
        return(
            <>
                ...
                {currentQuestion < QC.length - 1 &&  <button disabled={this.state.disabled} className="btn btn-success"  onClick={this.nextQuestionHandler}>Next</button> }
                {currentQuestion === QC.length - 1 &&  <button className="btn btn-success"  onClick={this.finishHandler}>Finish</button> }
