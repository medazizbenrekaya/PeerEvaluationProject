...
import {QM} from "../../assets/QuizData";
...
class QuizManaging extends  Component {
    ...
    loadQuiz = () =>{
        ...
        this.setState(()=> {
            return {
                questions: QM[currentQuestion].question,
                options: QM[currentQuestion].options,
                answers: QM[currentQuestion].answer
            }
        })
    }
    componentDidMount() {
    ...
    finishHandler = () =>{
        ...
        if(userAwnser === answers){
            ...
            if (score >= 16){
                this.setState({
                    ...
                    this.setState({
                        result: 'you have to work on your Management skill'
                        //function update
        ...
        if (this.state.currentQuestion === QM.length - 1 )
        {
            this.setState(
                {
                    quizEnd: true
                            ...
                            <div className="owner">
                                <div className="avatar">
                                    <img
                                        ...
                                        src={require('assets/img/faces/managing.png')}
                                        width={150}
                                    />
                                </div>
